...
const BodyMetricsModal = ({ onCloseWorkoutModal, onCloseBodyMetricsModal }) => {
  ...
  return (
    <div>
      <div className="p-8">
        <button
          onClick={onCloseBodyMetricsModal}
        ...
        <div className="flex gap-2 items-center my-3 font-semibold">
          <TbActivityHeartbeat className="text-red-500 text-xl" />
          <p className="text-xl">Body Metrics</p>
        </div>
        <form onSubmit={handleSubmit}>
          <div className="my-5 flex flex-col gap-5 justify-center">
            ...
            <div className="flex justify-around border p-8 rounded-md">
              <label className="label cursor-pointer">
                <input
                  type="checkbox"
                  className="checkbox checkbox-primary"
                  name="bodyFat"
                  checked={formData.bodyFat}
                  onChange={handleCheckboxChange}
                />
                <span className="label-text ml-3">Body Fat</span>
              </label>
              <label className="label cursor-pointer">
                <input
                  type="checkbox"
              ...
              <label className="label cursor-pointer">
                <input
                  ...
                  className="checkbox checkbox-primary"
                  name="hip"
                  checked={formData.hip}
                  onChange={handleCheckboxChange}
                />
                <span className="label-text ml-3">Hip</span>
              </label>
            </div>
